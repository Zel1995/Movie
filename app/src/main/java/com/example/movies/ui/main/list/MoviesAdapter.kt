...
class MoviesAdapter(private val movies: List<Movie>, private val onMovieClicked: (movie: Movie) -> Unit) :
    ...
    inner class MovieViewHolder(itemView: View,onMovieClicked: (movie: Movie) -> Unit) : RecyclerView.ViewHolder(itemView) {
